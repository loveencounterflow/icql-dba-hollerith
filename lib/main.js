(function() {
  'use strict';
  var CND, Dba, E, Hollerith2, SQL, badge, debug, echo, freeze, guy, help, info, isa, jp, jr, lets, name_re, rpr, type_of, types, urge, validate, validate_list_of, warn, whisper;
  ...
  this.Hollerith = class Hollerith { // extends Hollerith
      ...
      //---------------------------------------------------------------------------------------------------------
    constructor(cfg) {
      var descriptor, k, method, name, ref;
      ...
      ref = Object.getOwnPropertyDescriptors(this.hlr);
      for (name in ref) {
        descriptor = ref[name];
        ({
          value: method
